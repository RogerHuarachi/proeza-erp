...
@section('tittle')
    <div class="col-sm-6">
        <h1 class="m-0">inversionistas</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">inicio</a></li>
        <li class="breadcrumb-item active">inversionistas</li>
        </ol>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                @can('investors.create')
                    <form action="{{ route('investors.create') }}" method="get">
                    ...
                    <tbody>
                        @foreach ($investors as $investor)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <form action="{{ route('investors.show', $investor->id) }}" method="GET">
                                            <button class="btn btn-info btn-xs" type="submit"><i class="fas fa-eye"></i></button>
                                        </form>
                                        <form action="{{ route('investors.edit', $investor->id) }}" method="GET">
