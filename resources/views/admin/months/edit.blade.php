...
@section('tittle')
    ...
    <div class="col-sm-6">
        ...
        <li class="breadcrumb-item"><a href="{{ route('months.index') }}">meses</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                placeholder="Mes" name="name" value="{{ $month->name }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="select2-primary">
                                  <select class="select2" data-placeholder="Select a State" data-dropdown-css-class="select2-primary" style="width: 100%;" name="year_id" required>
                                    <option value="{{ $month->year->id }}">{{ $month->year->name }}</option>
