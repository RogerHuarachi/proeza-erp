        ...
        <div class="card">
            <div class="card-header">
                @can('interests.create')
                    <form action="{{ route('interests.create') }}" method="get">
                    ...
                    <tbody>
                        @foreach ($interests as $interest)
                            <tr>
                                ...
                                <td>{{ $interest->month->name }}</td>
                                <td>{{ $interest->money }}</td>
                                <td>
                                    <div class="btn-group">
                                        <form action="{{ route('interests.show', $interest->id) }}" method="GET">
                                            <button class="btn btn-info btn-xs" type="submit"><i class="fas fa-eye"></i></button>
                                        </form>
                                        <form action="{{ route('interests.edit', $interest->id) }}" method="GET">
